  ...
  <div id="container">
    <div id="scene"> <img src="../images/scene_1.gif" alt="" />
      ...
      <div id="menu">
        ...
        <div class="holder"> <a href="getBlogInfo.action">个性化设置</a> </div>
        <div class="holder"> <a href="addArticleTemp.action">日志</a> </div>
        ...
        <s:set name="loushu" value="#loushu + 1"></s:set>
		  ...
		  <div class="comment">
            ...
            <input type="hidden" name="id" value='${requestScope.article.id }'/>
              <div>
                <FCK:editor instanceName="content" basePath="/user/fckeditor" toolbarSet="myToolbar" height="300"></FCK:editor>
              </div>
              <div>
                <label></label>
                <div class="clear"> </div>
